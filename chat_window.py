...
class Ui_ChatWindow(object):
    def setupUi(self, ChatWindow):
        ...
        self.simplePage.setGeometry(QRect(0, 0, 98, 28))
        ...
        self.notebookPage.setGeometry(QRect(0, 0, 98, 28))
        ...
        self.paramAdvPage.setGeometry(QRect(0, 0, 219, 601))
        ...
        self.preferencesPage.setGeometry(QRect(0, 0, 155, 536))
        ...
        self.themesPage.setGeometry(QRect(0, 0, 191, 493))
...
#endif // QT_CONFIG(tooltip)
        self.bosIdText.setPlaceholderText(QCoreApplication.translate("ChatWindow", u"2", None))
